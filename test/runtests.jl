...
# !!! Main.UserApp is configured as an alias for Main.FactSimply and you might encounter it in some tests
using Main.FactSimply, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "FactSimply tests" begin
  @includetests ARGS
end
